...
/**
 * struct ion_flush_data - legacy cache-maintenance request
 * @handle: legacy handle; mapped to a dma-buf fd by CONFIG_ION_LEGACY
 * @fd: dma-buf fd used by newer clients
 * @vaddr: userspace mapping address retained for ABI compatibility
 * @offset: byte offset into the buffer
 * @length: number of bytes to maintain
 */
